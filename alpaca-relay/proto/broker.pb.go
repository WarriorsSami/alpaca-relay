...
const file_proto_broker_proto_rawDesc = "" +
	...
	"\tSubscribe\x12\x18.broker.SubscribeRequest\x1a\x0f.broker.Message0\x01B\x14Z\x12alpaca-relay/protob\x06proto3"
...
var file_proto_broker_proto_depIdxs = []int32{
	...
	1, // 2: broker.Broker.Publish:output_type -> broker.PublishResponse
	3, // 3: broker.Broker.Subscribe:output_type -> broker.Message
